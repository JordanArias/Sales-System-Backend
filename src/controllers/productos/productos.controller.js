...
const crearProducto = async (req, res) =>{
    ...
    try {
        await client.query('BEGIN'); // Comienza la transacción
        const text = ` INSERT INTO producto(cod_producto, nombre, precio, producto_unico, estado, cocina, cod_categoria, cod_subcategoria)
                       VALUES ($1, $2, $3, $4, $5, $6, $7, $8); `;
        const {cod_producto, nombre, precio, producto_unico, estado, cocina, cod_categoria, cod_subcategoria} = req.body[0];
        console.log('Producto Agregado',req.body);
        //AGREGAMOS EL PRODUCTO
        await client.query(text, [cod_producto, nombre, precio, producto_unico, estado, cocina, cod_categoria, cod_subcategoria]);
...
const modificarProducto = async (req, res) =>{
    ...
    try {
        await client.query('BEGIN'); // Comienza la transacción
        const modificar_producto = ` UPDATE producto SET nombre=$1, precio=$2, producto_unico=$3, estado=$4, cocina=$5, cod_categoria=$6, cod_subcategoria=$7
        ...
        await client.query(modificar_producto, [nombre, precio, producto_unico, estado, cocina, cod_categoria, cod_subcategoria, cod_producto]);
...
//************************************** :::::::::: PRETICION DE PRODUCTOS, COMPLEMENTO, OPCIONES, INSUMOS :::::::::: ************************************ */
//******************************************************************************************************************************************************** */
